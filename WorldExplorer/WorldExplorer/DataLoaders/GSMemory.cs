...
namespace WorldExplorer.DataLoaders
{
    internal class GSMemory
    {
        ...
        private readonly int[] columnByte8 =
        {
        ...
        private readonly int[] columnWord32 = {0, 1, 4, 5, 8, 9, 12, 13, 2, 3, 6, 7, 10, 11, 14, 15};

        private readonly int[,] columnWord4 =
        {
            {
        ...
        private readonly int[,] columnWord8 =
        {
            {
